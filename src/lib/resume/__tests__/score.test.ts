...
const base: CanonicalProfile = {
  version: 1, name: "M", email: "m@x.edu", phone: "5", preferredName: null, address: { street: null, city: null, state: null, zip: null }, links: { linkedin: "l", github: "g", portfolio: null }, headline: "IT student", targetRoles: ["SWE Intern"],
  ...
  education: [{ school: "NOVA", degree: "AAS", field: "IST", gradYear: 2027, startYear: null, gpa: null, coursework: [], source: "resume" }], certifications: [],
...
describe("scoreResume", () => {
  ...
  it("finds the classic problems and ranks by points", () => {
    const weak = { ...base, phone: null, preferredName: null, address: { street: null, city: null, state: null, zip: null }, links: { linkedin: null, github: null, portfolio: null }, skills: base.skills.slice(0, 4),
