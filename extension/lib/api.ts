...
export type Me = { name: string | null; email: string; plan: string; credits: number | "unlimited"; fields: Record<string, string | boolean | string[] | null>; prefs?: { essays: "draft" | "skip"; coverLetter: "when_asked" | "never"; resume: "tailored" | "base"; hoursPerWeek: string | null }; skills: string[]; experience?: MeExperience[]; education?: MeEducation[] };
...
export const api = {
  ...
  answers: (body: { url?: string; company?: string; title?: string; questions: { id: string; label: string; kind: string; options?: string[]; required?: boolean }[] }) => call<{ answers: { id: string; value: string | string[] | null; why: string; assumed?: boolean }[] }>("/api/ext/answers", { method: "POST", body: JSON.stringify(body) }),
